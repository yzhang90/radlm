...
#            Jason Larkin (jason.larkin@spiralgen.com) (Phase 2)
# 
# $Id$
#
...
class LandsharkWayPointController:
  def __init__(self):
    ...
    self.minDistanceToGoal = 1.0 #FIX ME
  ...
  def Initialize(self):
    ...
    odometryTopic = rospy.get_param('odometry_topic', '/radl/odom')
    velocityCommandTopic = rospy.get_param('base_velocity_command_topic', '/landshark_2dnav/base_velocity')
