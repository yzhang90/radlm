...
class LandsharkBase {
  public:
     ...
     */
    void GetWheelEncoders(long& rLeftWheelEncoder, long& rRightWheelEncoder, boost::posix_time::ptime& rTime);
  ...
  private:
    ...
    void UpdateEncoders(int leftEncoder, int rightEncoder, boost::posix_time::ptime time);
